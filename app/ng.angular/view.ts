...
export class Component implements OnInit {
    ...
    app = (() => {
        ...
        obj.load = async () => {
            ...
            //     tabs: [
            //         {
            //             name: "Module", mode: "code", path: "angular/app/app.module.ts", viewref: MonacoEditor,
            ...
            //     tabs: [
            //         {
            //             name: "Routing", mode: "code", path: "angular/app/app-routing.module.ts", viewref: MonacoEditor,
            //             config: { language: 'typescript', renderValidationDecorations: 'off', ...monacoConfig }
            //         }
            //     ]
            // }, {
            ...
            //     tabs: [
            //         {
            //             name: "index", mode: "code", path: "angular/index.pug", viewref: MonacoEditor,
            //             config: { language: 'pug', ...monacoConfig }
            //         },
            //         {
            //             name: "app-root", mode: "code", path: apppath + "/app.component.pug", viewref: MonacoEditor,
            //             config: { language: 'pug', ...monacoConfig }
            //         },
            //         {
            //             name: "component", mode: "code", path: apppath + "/app.component.ts", viewref: MonacoEditor,
            //             config: { language: 'typescript', renderValidationDecorations: 'off', ...monacoConfig }
            //         },
            //         {
            //             name: "scss", mode: "code", path: apppath + "/app.component.scss", viewref: MonacoEditor,
            ...
            //     tabs: [
            //         {
            //             name: "Routing", mode: "code", path: "angular/angular.build.options.json", viewref: MonacoEditor,
            ...
            //     tabs: [
            //         {
            //             name: "Module", mode: "code", path: "angular/wiz.ts", viewref: MonacoEditor,
            //             config: { language: 'typescript', renderValidationDecorations: 'off', ...monacoConfig }
            //         },
            //     ]
            // }];
